  ...
  useEffect(() => {
    if (product) {
      ...
      setCustomization({
        ...
        isDigitalProduct:
          product.type === "digital" || product.isDigital || false,
        ...
        buttonColor:
          !product.use_global_colors && product.button_color
            ? product.button_color
            : defaultCustomization.buttonColor,
        headingColor:
          !product.use_global_colors && product.heading_color
            ? product.heading_color
            : defaultCustomization.headingColor,
        bannerColor:
          !product.use_global_colors && product.banner_color
            ? product.banner_color
            : defaultCustomization.bannerColor,
      });
