...
export const trackPurchase = (
  ...
  console.log(
    `[PIXEL AUDIT] Tracking purchase: OrderID=${orderId}, Value=${value}, Initialized=${isInitialized}`,
  );

  if (process.env.NODE_ENV !== "production" && !isInitialized) {
    console.log(
      "[PIXEL AUDIT] Purchase tracking skipped: development mode or pixels not initialized",
    );
    return;
  }
  ...
  if (typeof window !== "undefined" && window.googleAdsPixels) {
    window.googleAdsPixels.forEach((pixel) => {
      console.log(
        `[PIXEL AUDIT] Firing Google Ads conversion for ID: ${pixel.googleAdsId}, Label: ${pixel.conversionLabel}`,
      );
      GooglePixel.trackPurchase(orderId, value, pixel.conversionLabel);
    });
  } else {
    console.log(
      "[PIXEL AUDIT] No Google Ads pixels available in window object",
    );
  }
  ...
  if (typeof window !== "undefined" && window.facebookPixels) {
    window.facebookPixels.forEach((pixel) => {
      console.log(
        `[PIXEL AUDIT] Firing Facebook pixel conversion for ID: ${pixel.facebookPixelId}`,
      );
  ...
  if (typeof window !== "undefined" && window.tiktokPixelId) {
    console.log(
      `[PIXEL AUDIT] Firing TikTok pixel conversion for ID: ${window.tiktokPixelId}`,
    );
  ...
  if (typeof window !== "undefined" && window.taboolaAccountId) {
    console.log(
      `[PIXEL AUDIT] Firing Taboola pixel conversion for ID: ${window.taboolaAccountId}`,
    );
  ...
  if (typeof window !== "undefined" && window.outbrainPixelId) {
    console.log(
      `[PIXEL AUDIT] Firing Outbrain pixel conversion for ID: ${window.outbrainPixelId}`,
    );
  ...
  if (typeof window !== "undefined" && window.uolAdsId) {
    console.log(
      `[PIXEL AUDIT] Firing UOL Ads pixel conversion for ID: ${window.uolAdsId}`,
    );
