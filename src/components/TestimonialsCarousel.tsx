...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment:
      "App incrível! Fácil de usar e muito eficiente. Estou adorando a experiência!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Rápido, direto e sem enrolação. Recomendo para todos que querem um checkout eficiente.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Estou muito satisfeita com a praticidade do app. Fiz minha compra em segundos!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Nunca vi um aplicativo tão bem pensado. Intuitivo e seguro, nota 10!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Comprei meu produto e recebi acesso na hora. Melhor experiência de compra online!",
