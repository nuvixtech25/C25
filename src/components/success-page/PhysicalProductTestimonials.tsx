  ...
  const testimonials = [
    {
      ...
      comment:
        "Produto chegou no prazo combinado! Embalagem perfeita e produto de qualidade.",
    ...
    },
    {
      ...
      comment:
        "Produto de qualidade TOP! Superou minhas expectativas, recomendo!",
    ...
    },
    {
      ...
      comment:
        "Cumpre o que promete! Exatamente como descrito na página do produto.",
  ...
  return (
    <div className="mt-6 bg-gray-50 p-5 rounded-xl border border-gray-100">
      <h3 className="font-medium text-gray-800 mb-4 text-lg flex items-center gap-2">
        <Package className="h-5 w-5 text-gray-600" />O que nossos clientes estão
        dizendo sobre este produto:
      </h3>
