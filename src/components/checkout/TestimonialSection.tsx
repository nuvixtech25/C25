...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment:
      "Estou muito satisfeito com o serviço, realmente entregam o que promete",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "melhor investimento que fiz, tenho tudo na minha tv e celular por um valor simbólico, obrigado por existir cineflick s2",
...
export const TestimonialSection: React.FC<TestimonialSectionProps> = ({
  ...
  return (
    <section
      ...
      className="mb-4 bg-white rounded-lg border border-[#E0E0E0]"
    >
      <div className="p-4">
        ...
        <div className="border border-[#E0E0E0] rounded-lg p-4 bg-white">
          ...
          <div className="bg-[#E6F4EA] border border-[#28A745] rounded-md p-3 mt-4 flex items-center">
            ...
            <p className="text-sm">
              Entrega via Email: Você receberá os dados de acesso em seu email
              cadastrado imediatamente após a confirmação do pagamento.
            </p>
          </div>
        </div>
      </div>
