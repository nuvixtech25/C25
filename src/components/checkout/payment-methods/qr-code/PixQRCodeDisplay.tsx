...
export const PixQRCodeDisplay: React.FC<PixQRCodeDisplayProps> = ({
  ...
  useEffect(() => {
    console.log(
      "PixQRCodeDisplay - Received QR code:",
      qrCodeImage
  ...
  if (
    ...
    (qrCodeImage?.trim() === "" && fixedQRCodeImage?.trim() === "")
  ) {
    return (
        ...
        <div className="relative">
          <div className="relative p-6 bg-gray-50 rounded-xl border border-gray-200 w-full max-w-[280px] h-[280px] mx-auto flex flex-col items-center justify-center text-gray-500">
            ...
            <p className="text-center text-sm">
              ...
              <br />
              Use o código de cópia e cola abaixo.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="relative group">
        <div
          className={`relative p-4 bg-white rounded-xl ${containerSize} mx-auto flex items-center justify-center overflow-hidden`}
        >
          {isLoading && (
