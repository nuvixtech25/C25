    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-white to-red-50">
      <Card className="max-w-md w-full shadow-xl border border-red-100 rounded-xl overflow-hidden">
        ...
        <CardContent className="text-center space-y-4 px-6 py-6">
          <p className="text-gray-700">Seu pagamento não pôde ser processado. Por favor, tente novamente ou escolha outra forma de pagamento.</p>
          
          <div className="p-4 bg-red-50 rounded-lg border border-red-100 my-6 animate-pulse-slow">
            <p className="text-red-700 font-medium">Se você já realizou o pagamento e está vendo esta mensagem, entre em contato com nosso suporte.</p>
          </div>
        </CardContent>
