...
export const DigitalProductSection: React.FC<DigitalProductSectionProps> = ({
  isDigital = false,
}) => {
    ...
    <div className="p-5 bg-purple-50 rounded-lg border border-purple-100 my-4 flex items-start">
      ...
      <div className="text-left">
        ...
        <p className="text-gray-600 mt-1">
          Clique no botão abaixo para ver seus dados de acesso ao produto
          digital.
        </p>
      </div>
    </div>
...
export const DigitalProductButton: React.FC<DigitalProductSectionProps> = ({
  isDigital = false,
}) => {
  if (!isDigital) return null;
