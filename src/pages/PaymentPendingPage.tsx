...
const PaymentPendingPage = () => {
  ...
  useEffect(() => {
    console.log(
      "[PaymentPendingPage] Full location state:",
    ...
    const timer = setTimeout(() => {
      ...
      if (state?.order) {
        ...
        if (state.has_whatsapp_support) {
          ...
          console.log(
            "[PaymentPendingPage] WhatsApp support enabled with number:",
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
              <div className="flex items-start">
                ...
                <p className="text-blue-800">
                  Recebemos seu pagamento e ele está sendo analisado pela
                  operadora do cartão.
                </p>
              </div>
            </div>
            ...
            <div className="bg-amber-50 p-4 rounded-lg border border-amber-100">
              <div className="flex items-start">
                ...
                <p className="text-amber-800">
                  Assim que tivermos uma resposta, você será notificado por
                  e-mail sobre o status do seu pagamento.
                </p>
              </div>
            </div>
            ...
            <div className="bg-purple-50 p-4 rounded-lg border border-purple-100 shadow-sm">
              <div className="flex items-start">
                ...
                <p className="text-purple-800 font-medium">
                  Utilizar um cartão diferente aumenta suas chances de
                  aprovação.
                </p>
              </div>
            </div>
