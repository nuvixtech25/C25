...
const PaymentAnalysisPage: React.FC = () => {
          ...
          <div className="flex items-center justify-center my-6">
            <div className="h-16 w-16 relative">
              ...
              <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center text-primary">
                ...
                >
                  <path
                    d="M12 4V2M12 20V22M6.31 6.31L4.89 4.89M17.69 17.69L19.11 19.11M4 12H2M20 12H22M6.31 17.69L4.89 19.11M17.69 6.31L19.11 4.89"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
  ...
  return <PaymentAnalysisLayout>{renderContent()}</PaymentAnalysisLayout>;
};
