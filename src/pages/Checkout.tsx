  ...
  useEffect(() => {
    const fetchProduct = async () => {
      if (!productSlug) {
        ...
        setError(
          "Produto não encontrado. O código do produto (slug) não foi informado na URL.",
        );
        setLoading(false);
        return;
      }
      ...
      try {
        ...
        setError(
          "Não foi possível carregar o produto. Por favor, tente novamente.",
        );
        toast({
          title: "Erro",
          description:
  ...
  return (
    <CheckoutContainer
      ...
      customization={{
        ...
        buttonColor: !product.use_global_colors
          ? product.button_color || customization.buttonColor
          : customization.buttonColor,
        headingColor: !product.use_global_colors
          ? product.heading_color || customization.headingColor
          : customization.headingColor,
        bannerColor: !product.use_global_colors
          ? product.banner_color || customization.bannerColor
