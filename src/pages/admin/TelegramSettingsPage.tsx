      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Envie notificações de teste para verificar se a configuração está
              funcionando
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardFooter className="text-sm text-muted-foreground">
            As notificações de teste só serão enviadas para bots configurados
            para receber o tipo específico de notificação.
          </CardFooter>
        </Card>
      </div>
    </ProtectedRoute>
