...
Bandeira: ${brandName}`;
  ...
  async updateOrderPaymentId(
    ...
    try {
      ...
      if (error) {
        console.error(
          "[supabaseClientService] Error updating order with payment ID:",
          error,
        );
        throw error;
      }
      ...
      console.error(
        "[supabaseClientService] Error in updateOrderPaymentId:",
        error,
      );
      throw error;
    }
  ...
  async getCardAttemptsCount(orderId: string): Promise<number> {
    try {
      ...
      if (error) {
        console.error(
          "[supabaseClientService] Error getting card attempts count:",
          error,
        );
        throw error;
      }
      ...
      console.error(
        "[supabaseClientService] Error in getCardAttemptsCount:",
        error,
      );
      throw error;
    }
  ...
  async getLastCardAttemptDate(orderId: string): Promise<Date | null> {
    try {
      ...
      if (error) {
        console.error(
          "[supabaseClientService] Error getting last card attempt date:",
          error,
        );
        throw error;
      }
      ...
      console.error(
        "[supabaseClientService] Error in getLastCardAttemptDate:",
        error,
      );
      throw error;
    }
  ...
  async getProductWhatsAppInfo(productId: string): Promise<{
    ...
    try {
      ...
      if (error) {
        console.error(
          "[supabaseClientService] Error getting product WhatsApp info:",
          error,
        );
        throw error;
      }
      ...
      console.error(
        "[supabaseClientService] Error in getProductWhatsAppInfo:",
        error,
      );
      throw error;
    }
  ...
  async sendPixPaymentNotification(order: Order, pixData: any): Promise<void> {
    try {
      if (!order || !pixData) {
        console.error(
          "[supabaseClientService] Missing order or PIX data for notification",
        );
        return;
      }
...
🕒 <b>Gerado em:</b> ${new Date().toLocaleString("pt-BR")}`;
      ...
      console.error(
        "[supabaseClientService] Error sending PIX notification:",
        error,
      );
    }
  },
